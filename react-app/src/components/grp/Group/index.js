    ...
    return (
      <div className="groupContainer">
        ...
        <div className="expenseDetails">
          <div className="expense">
            <div className="expenseSelectorContainer">
              <select
                ...
                onChange={exp}
              >
                <option value={-6}>Please select an option</option>
            ...
            <div className="viewExpenseButtonContainer">
              <button className="viewExpenseButton" onClick={handleExpenses}>
                view expense
              </button>
            </div>
            <Modal className="expModal" style={style} isOpen={modalIsOpen}>
              <div>
                <button className="xButton" onClick={handleExpenses}>
                  x
                </button>
          ...
          <div>
            <div>
              <button className="createExpButton" onClick={toggleCreate}>
                + new expense
              </button>
            </div>
          </div>
        ...
        <div className="transactionButtonContainer">
          <button className="transButton" onClick={toggleTransactions}>
            view transactions
          </button>
        </div>
      </div>
